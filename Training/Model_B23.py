# This model consists of 8 Layer and bicubic interpolation rest is similar to baseline model 
...
class Autoencoder(nn.Module):
    def __init__(self):
        ...
        self.l1 = nn.Linear(64 * 1 * 2, 32)  # first linear layer for encoder part
        self.l2 = nn.Linear(32, 64 * 1 * 2) # second linear layer for decoder part
