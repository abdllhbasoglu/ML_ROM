# This model consists of 5 Layer and 'Bicubic' interpolation for upsampling. Rest is similar to baseline model 
...
class Autoencoder(nn.Module):
    def __init__(self):
        ...
        self.l1 = nn.Linear(64 * 6 * 16, 32)  # first linear layer for encoder part
        self.l2 = nn.Linear(32, 64 * 6 * 16) # second linear layer for decoder part
