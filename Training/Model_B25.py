# This model consists of 8 Layer and bicubic interpolation and LV=16 rest is similar to baseline model 
...
class Autoencoder(nn.Module):
    def __init__(self):
        ...
        self.l1 = nn.Linear(64 * 1 * 2, 16)  # first linear layer for encoder part
        self.l2 = nn.Linear(16, 64 * 1 * 2) # second linear layer for decoder part
