# This model consists of 8 Layer, bicubic interpolation and tanh act func to FCN rest is similar to baseline model 
...
class Autoencoder(nn.Module):
    def __init__(self):
        ...
        self.l1 = nn.Sequential(nn.Linear(64 * 1 * 2, 32), nn.Tanh())  # first linear layer for encoder part
        self.l2 = nn.Sequential(nn.Linear(32, 64 * 1 * 2), nn.Tanh())  # second linear layer for decoder part
        ...
        self.decoder = nn.Sequential(
            ...
            #1
            nn.Upsample(size=(2,4), mode='bicubic'),
