# This model consists of 6 Layer and bicubic interpolation for upsampling. Rest is similar to baseline model 
...
class Autoencoder(nn.Module):
    def __init__(self):
        ...
        self.l1 = nn.Sequential(nn.Linear(64 * 4 * 8, 32), nn.Tanh())  # first linear layer for encoder part
        self.l2 = nn.Sequential(nn.Linear(32, 64 * 4 * 8), nn.Tanh())  # second linear layer for decoder part
        
        # Decoder kısmı
        self.decoder = nn.Sequential(
            nn.Unflatten(1, (64, 4, 8)),
