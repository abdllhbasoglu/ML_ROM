...
class Autoencoder(nn.Module):
    def __init__(self):
        ...
        self.l1 = nn.Linear(64 * 2 * 4, 16)  # first linear layer for encoder part
        self.l2 = nn.Linear(16, 64 * 2 * 4) # second linear layer for decoder part
    ...
    def _initialize_weights(self):
        for m in self.modules():
            if isinstance(m, nn.Conv2d) or isinstance(m, nn.ConvTranspose2d):
                init.kaiming_normal_(m.weight, mode='fan_out', nonlinearity='elu')
