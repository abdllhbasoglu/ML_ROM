...
class Autoencoder(nn.Module):
    def __init__(self):
        ...
        self.l1 = nn.Sequential(nn.Linear(64 * 2 * 4, 32), nn.LeakyReLU())  # first linear layer for encoder part
        self.l2 = nn.Sequential(nn.Linear(32, 64 * 2 * 4), nn.LeakyReLU()) # second linear layer for decoder part
