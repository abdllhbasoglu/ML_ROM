# This model consists of 5 Layer, 'Bicubic' interpolation for upsampling and tanh Activation function after FCN. Rest is similar to baseline model 
...
class Autoencoder(nn.Module):
    def __init__(self):
        ...
        self.l1 = nn.Sequential(nn.Linear(64 * 6 * 16, 32), nn.Tanh())  # first linear layer for encoder part
        self.l2 = nn.Sequential(nn.Linear(32, 64 * 6 * 16), nn.Tanh())  # second linear layer for decoder part
