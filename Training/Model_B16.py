# This model consists of 5 Layer, 'Bicubic' interpolation for upsampling and Latent Space = 24. Rest is similar to baseline model 
...
class Autoencoder(nn.Module):
    def __init__(self):
        ...
        self.l1 = nn.Linear(64 * 6 * 16, 24)  # first linear layer for encoder part
        self.l2 = nn.Linear(24, 64 * 6 * 16) # second linear layer for decoder part
